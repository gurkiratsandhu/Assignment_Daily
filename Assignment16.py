...
try:
    db = py.connect("localhost",'root','yash','assignment')
    cursor = db.cursor()
    qr = "show databases"
    cursor.execute(qr)
    qr1 = "use assignment"
...
cursor.execute(qr2)
qr3 = "insert into Authors values(102,'Amar','kumar','dev')"
cursor.execute(qr3)
qr4 = "insert into Authors_Titles values(1005,256,1010)"
cursor.execute(qr4)
qr5 = "insert into Publishers values(2211,'Rohan','poojaVihar',3880,544)"
cursor.execute(qr5)
qr6 = "insert into zip_codes values(812,'Ambala','Haryana',1303)"
cursor.execute(qr6)
cursor.fetchall()
db.commit()
db.close()
